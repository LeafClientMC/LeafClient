...
public sealed class TutorialService
{
    ...
    public List<TutorialStep> Steps { get; } = new()
    {
        ...
        new TutorialStep
        {
            ...
            Body = "Click the Resource Packs tab to browse and install textures from Modrinth.",
        ...
        new TutorialStep
        {
            ...
            Body = "Click Browse Resource Packs to discover packs from Modrinth.",
            WaitForClickElement = "ModsBrowseBtn",
            TooltipAnchor = TooltipAnchor.Below
        },
        new TutorialStep
        {
            ...
            Body = "Search for resource packs and click Install to add them to your game.",
            IsSkippable = true,
            SkipLabel = "Next →",
            TooltipAnchor = TooltipAnchor.Right
        },
        ...
        new TutorialStep
        {
            ...
            Body = "Click here to open the Skins page and customise your Minecraft skin.",
        ...
        new TutorialStep
        {
            TargetElementName = "SkinsPage",
            Title = "Manage Your Skins",
            Body = "This is the Skins page. Upload new skins, edit existing ones, or apply them to your Minecraft account here.",
            NavigateToPage = 5,
            TooltipAnchor = TooltipAnchor.Left,
            IsSkippable = true,
            SkipLabel = "Next →",
