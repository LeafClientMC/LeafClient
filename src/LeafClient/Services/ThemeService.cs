...
namespace LeafClient.Services
{
    public static class ThemeService
    {
        ...
        private static void ApplyTheme()
        {
            ...
            var primaryAccentColor = Color.Parse("#22C55E");
            ...
            accentGradient.GradientStops.Add(new GradientStop(Color.Parse("#22C55E"), 0));
            accentGradient.GradientStops.Add(new GradientStop(Color.Parse("#16A34A"), 1));
