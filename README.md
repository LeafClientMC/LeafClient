...
A **Minecraft Java Edition** client and launcher, **no cheats (features that are OP can be disabled by servers through our [docs](https://leaflcient.com/docs)), no bypasses, no shady business**.
...
- Linux single file Executable (.AppImage)

---

## Want to contribute or just follow along?
