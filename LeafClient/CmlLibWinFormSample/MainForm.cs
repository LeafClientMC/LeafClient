...
namespace Leaf_Client
{
    public partial class MainForm : Form
    {
        ...
        // Example using Windows API for overlay
        [DllImport("user32.dll", SetLastError = true)]
        ...
        //TestForm overlayForm = new TestForm();

        private void ChangeMinecraftName_Tick(object sender, EventArgs e)
        {

            if (p.HasExited == true)
                Console.WriteLine("Minecraft has been closed.");
            ...
            try
            {
                ...
                if (IsWindowVisible(p.MainWindowHandle) == true)
                {
                    ...
                    IntPtr customIconHandle = LoadImage(IntPtr.Zero, "C:\\Users\\pronn\\Downloads\\Leaf Client.ico", IMAGE_ICON, 0, 0, LR_LOADFROMFILE);
